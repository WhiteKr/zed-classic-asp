...
- **Go to definition** on function/sub names — searched through the current file and its include chain, falling back to the whole workspace. Declaration order does not matter (a `Sub` defined after its call site is found)
